...
<html>
	<head>
		...
		<style>
			...
			body {
					 background-image: url("image/lab84.png");
		...
		<div class = "container">
			<form method= "POST" action="">
				...
				<!--<div class="form-group">
					...
					<input type = "text" name="rptID" class= "from-control" >
				</div>
				<br>-->
				...
				<div class="column1" style="background-color:white;">
					...
					<input type="submit" name="rstitem" class="btnl" onclick="location.href='ReportD.php'" value="LAB">
	...
	//insert query
	$sql = "INSERT INTO lab_report (Report_Name,Duration_to_Return,Price) VALUES 
	('$Report_Name','$Duration_to_Return',$Price)";
