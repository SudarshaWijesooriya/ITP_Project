	...
	<div class = "background">
		...
		<div class="container">
		   ...
		   <div class="profile">
			  ...
			  <!--<a href="#" class="btnForeign">Pharmacy Page</a>-->
			  <a href="ComplainPageClient.php" class="btnForeign">Feedback Page</a>
			  <a href="MakeAppointment.php" class="btnForeign">Appointment Page</a>
			  <a href="makepay.php" class="btnForeign">Payment Page</a>
		   </div>
		 ...
		 <div class='patientrecords'>
		   <div class='child'> <!--Patient Lab Records-->
				...
				<tr>
					...
					<th>Cost:</th><td>
					<th>Patient RequestedDate:</th><td>
				...
				if ($result->num_rows > 0){
					while ($row = $result-> fetch_assoc()){
						echo "<tr><td>" . $row ["PatientID"] . "<td><td>" . $row ["Lab_ReportID"] . "<td><td>" . $row ["Report_Status"] . "<td><td>" . $row ["Cost"] . "<td><td>" . $row ["Patient_RequestedDate"] . "<td><td>" . $row ["Patient_IssuedDate"] . "<td><td>" . $row ["Treatment_ID"] . "<tr><td>" ;
					}
				}
				else{
					echo "No Results";
		...
		<div class='loginheading'><h3>Click the button below to generate a report to see patients count by their age </h3><a href="patient_report.php" class="btnForeign">Check Patients Percentage</a>
		</div></div>
