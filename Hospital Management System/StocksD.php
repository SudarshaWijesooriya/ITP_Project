...
<html>
	<head>
		...
		<link rel="stylesheet" href="Styles/sdback.css">
					...
					<table class="fl-table">
						...
						<tbody>
							<tr> 
								...
								<td><button type="button" class="ssbutton" onclick="myFunction()"><a href="show.php?did=<?php echo $row["ItemID"]; ?>">Delete</a></button></td><!>
							</tr>
						<?php
