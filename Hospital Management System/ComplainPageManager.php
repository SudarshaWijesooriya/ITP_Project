...
<html>
	...
	<head>
		...
		<!-- add a title (a)-->
		<title>Complain Page Manager</title>
		...
		<link rel="stylesheet" href="Styles/ComplainPageManager.css"><!--NEW-->
	...
	<body>
		...
		<div class = "alert alert-info">
			...
			<strong>You are In Manager Complain Page</strong>
		</div>
		...
		<div class="container">
            ...
            <div class="panel-group" id="accordion">
                ...
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title">
                      <a data-toggle="collapse" data-parent="#accordion" href="ComplainPage_1.php">Sorted method :- Manual Search</a>
                    </h4>
                  </div>
                  <div id="ex1" class="panel-collapse collapse in">
                    <div class="panel-body">Complains can be searched manually</div>
                  </div>
                </div>
                ...
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title">
                      <a data-toggle="collapse" data-parent="#accordion" href="ComplainPage_2.php">Sorted method :- Latest Received</a>
                    </h4>
                  </div>
                  <div id="ex2" class="panel-collapse collapse in">
                    <div class="panel-body">Latest complains will be here</div>
                  </div>
                </div>
