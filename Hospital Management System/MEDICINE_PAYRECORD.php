...
$sql = "SELECT p.PatientID , p.First_Name , p.Telephone , ph.total_amount,ph.status,ph.PharmacyID
...
?>
	...
	<div class="box-1" onclick="window.location='UPDATE_PAYrecord.php';">
					  <div class="btn btn-one">
						<span>UPDATE PAYRECORD</span>
