...
<html>
	<head>
		...
		<link rel="stylesheet" href="Styles/sback.css">
					...
					<table class="fl-table">
						...
						?>
							...
							<tr> 
								...
								<td><button type="button" class="ssbutton" onclick="myFunction()"><a href="dsup.php?did=<?php echo $row["SupplierID"]; ?>">Delete</a></button></td><!>
							</tr>
						<?php
