	...
	<div class="wrapper">
			...
			<div class="inner">
				...
				<div>
					...
					<h3>Update PayRecord</h3><br>
			
				<div class="form-wrapper">
				<center><lable for ="id" style="color:black; text-size: 20px;">  <b>PharmacyID </b></label>
				...
				<div class="form-wrapper">
				<center><lable for ="id"  style="color:black; text-size: 25px;"><b>Total_Amount</b></label>
				&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
				&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
				...
				<center><lable for ="id"  style="color:black; text-size: 20px;"><b>Status</b></label>
				&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
