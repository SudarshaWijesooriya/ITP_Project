...
<center><div class="wrapper">
			...
			<div class="inner">
				<form method="POST" name="form" action="">
					...
					<center><label for="">Medicine ID</label>
					
					<input type="text" name="mid" class="form-control" placeholder="1"></center>
				</div>
					<br>
					
					<input type= "submit" name="btnSubmit" value="DELETE" class="button"><br>
