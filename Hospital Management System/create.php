...
<center> Doctor ID </br> <input type="text" name="DoctorID"><br></center>
</br> </br> </br>
...
<?php
	...
	$sql = "INSERT INTO appointment (Appointment_Time,Appointment_Date, Status  , price,DoctorID ) VALUES ('$Appointment_Time','$Appointment_Date' , '$Status', '$price' , '$DoctorID')";
	if($con -> query($sql))
	{
