	...
	<div class = "container">
			<form method="POST" action="">
				...
				<div class="column1" style="background-color:white;">
					...
					<input type="submit" name="rstitem" class="btnl" onclick="location.href='PatientReportDetails.php'" value="BACK">
		...
		<div class = "container2">
			...
			<form method="POST"  action="">
				...
				<label for = "">Report Status  </label>
					...
					<div class="form-group">
						<label for = "">Report Issued Date :</label>
						<input type = "date" name="issueddate" class= "from-control" required>
					</div>
...
<?php		
		...
		//update---------------------------------------------------------
			...
			{				
				...
				$Report_sts = $_POST['reortstatus'];
				$Issued_date = $_POST['issueddate'];
				
				//update query
				$sqlq = "UPDATE  lab SET Report_Status='".$_POST['reortstatus']."' , Patient_IssuedDate='".$_POST['issueddate']."' WHERE Lab_ReportID = '".$_POST['lbrptid']."' ";
