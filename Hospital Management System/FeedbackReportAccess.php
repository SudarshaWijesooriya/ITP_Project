...
<html>
	...
	<body>
		...
		<div class = "alert alert-info">
			...
			<strong>You are In Feedback Report Page</strong>
		</div>
		...
		<div class="container">
            ...
            <div class="panel-group" id="accordion">
                ...
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title">
                      <a data-toggle="collapse" data-parent="#accordion" href="FeedbackReportPieChart.php">Feedback Report - Pie Chart</a>
                    </h4>
                  </div>
                  <div id="ex1" class="panel-collapse collapse in">
                    <div class="panel-body">Generate a report which contains feedback information in a pie chart</div>
                  </div>
                </div>
				...
				<div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title">
                      <a data-toggle="collapse" data-parent="#accordion" href="FeedbackReportBarChart.php">Feedback Report - Bar Chart</a>
                    </h4>
                  </div>
                  <div id="ex1" class="panel-collapse collapse in">
                    <div class="panel-body">Generate a report which contains feedback information in a bar chart</div>
                  </div>
                </div>
				...
				<div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title">
                      <a data-toggle="collapse" data-parent="#accordion" href="FeedbackReportGaugeChart.php">Feedback Report - Gauge Chart</a>
                    </h4>
                  </div>
                  <div id="ex1" class="panel-collapse collapse in">
                    <div class="panel-body">Generate a report which contains feedback information in a gauge chart</div>
                  </div>
                </div>
