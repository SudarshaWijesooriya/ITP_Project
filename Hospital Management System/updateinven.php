...
<html>
	<head>
		...
		<link rel="stylesheet" href="Styles/updatebk.css">
					...
					<center>
						<div class="form-row">
							<div class="form-wrapper">
								...
								<input type="text" name="ID" class="form-control" placeholder="<?php echo $row['ItemID']?>" Value="<?php echo $row['ItemID']?>" readonly>
							</div>
						</div>	
						<div class="form-row">
							<div class="form-wrapper">
