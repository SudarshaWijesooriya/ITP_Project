...
<html>
	...
	<head>
		...
		<!-- add a title (a)-->
		<title>Complain Page Client</title>
	...
	<body>
		...
		<div class = "alert alert-info">
			...
			<strong>You are In User Complain Page</strong>
		</div>
		...
		<div class = "container">
			...
			<div class="wrapper">
				<form class="form" method="POST" action="php/complain_record_add.php">
				  <div class="pageTitle title">Complain</div>
				  <div class="secondaryTitle title">Please enter your complain below</div>
				  <textarea class="message formEntry" placeholder="Mention your complain Here" name ="new_user_complain"></textarea>
