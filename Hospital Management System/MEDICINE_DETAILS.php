...
<center>
		<div class="maindiv">
		<center><h2 style="color:black; text-decoration: underline;">MEDICINE DETAILS</h2></center>
...
if($result -> num_rows > 0)
{
	...
	while($row = $result -> fetch_assoc())
	{
		...
		echo '<td> <a href="update1.php">
		<input type="submit" class= "sbutton" value="UPDATE" name="btnsubmit" ></a> </td>';
		echo '<td> <a href="DELETE.php">
		<input type="submit" class= "sbutton1" value="DELETE" name="btnsubmit" ></a> </td>';
		echo '<td> <a href="Request.php">
		<input type="submit" class= "sbutton" value="REQUEST" name="btnsubmit" ></a> </td>';
		echo "</tr>";	
		echo "</tbody>";
	}
...
?>
	<br><br><br>
	<div class="box-1" onclick="window.location='ADD1.php';">
