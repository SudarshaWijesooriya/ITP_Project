		...
		<div class="box">
			...
			if( $result) {
				if (mysqli_num_rows($result) > 0) {
					...
					echo "<p><h3> Appoitment Fee : 400 </h3></p>";
				...
				if( $labfee == null || $pharmacybill == null ) {
					echo "No records";
				}
			
			
				else{
					$tot = 400 + $labfee + $pharmacybill;
					...
					if (strcmp($getstatus,"Not Paid")==0) {
						echo "<a href='paynow.php'><input class='button' type='button' name='pay' id='pay' value='Pay now'> </a>";
						echo "<a href='quickpay.php'><input class='button1' type='button' name='quick' id='quick' value='Quick Pay'></a>";
						# code...
					}else{
						echo "Bill Setteled";
					}
