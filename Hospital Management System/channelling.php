...
input[type=text]:focus {
  width: 40%;
	...
	<br><br>
	<center><h1>PATIENT APPOINTMENTS</h1></center>
<center>
		<div class="container">
...
$sql = "SELECT d.Specialization, d.Frist_Name , d.Last_Name , a.Appointment_Time , a.Appointment_Date , p.First_Name , p.Last_Name, p.Email
		FROM doctor d , appointment a , patient p
		WHERE a.DoctorID = d.DoctorID AND p.DoctorID = d.DoctorID AND  a.AppointmentID LIKE  '$AppointmentID' ";
...
if($result -> num_rows > 0)
{
	...
	echo "<th> Specialization </td> <th> Doctor Name </th> <th> Surname </th>  <th>  Appointment Time 
	</th> <th> Appointment Date </th> <th> Patient first Name </th> <th> Patient Last Name </th> <th> Email </th>  <th> </th> ";
