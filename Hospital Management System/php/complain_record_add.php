<?php
  ...
  @$user_complain = $_POST['new_user_complain'];

  
  if(isset($submission_button)){


    @$sql = " INSERT INTO complaint(ComplaintID,complaints,Answers,Feedback_ManagerID,PatientID) VALUES ('','$user_complain','<empty>','0','$user_id') " ;
